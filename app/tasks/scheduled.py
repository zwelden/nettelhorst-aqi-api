...
def _get_30_minute_windows(start_time: datetime, end_time: datetime) -> List[tuple]:
    """
    ...
    """
    windows = []
    current = _round_down_to_half_hour(start_time)
...
def _average_measure_data(records: List[Aqi5MinuteHistory]) -> Dict[str, float]:
    """
...
async def aggregate_30_minute_data():
    ...
    try:
        ...
        max_end_time = _round_down_to_half_hour(buffered_time)
        ...
        for location in locations:
            ...
            with SessionLocal() as db:
                ...
                windows = _get_30_minute_windows(start_time, max_end_time)
                ...
                for window_start, window_end in windows:
                    ...
                    averaged_data = _average_measure_data(window_records)
